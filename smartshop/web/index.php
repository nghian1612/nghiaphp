			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class=" menu__item"><a class="menu__link" href="codes.php">Short Codes</a></li>
...
<div class="footer">
	<div class="container">
		...
		<div class="col-md-9 footer-right">
			...
			<div class="sign-grds">
				...
				<div class="col-md-4 sign-gd-two">
					...
					<ul>
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>1234 Đường 6, Phường 28, Quận 15, <span>Thành Phố Hồ Chí Minh</span></li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i>Email : <a href="1234@gmail.com">1234@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>Phone : 0123456789</li>
					</ul>
				</div>
		...
		<div class="clearfix"></div>
		<p class="copy-right">&copy 2016 Smart Shop. All rights reserved | Design by <a href="https://landingpage-vietnam.com/"></a></p>
	</div>
</div>
<!-- //footer -->
<!-- login -->
